      ...
      <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
        <div className="w-full justify-start items-center gap-4 md:gap-12 grid lg:grid-cols-2 grid-cols-1">
          ...
          <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
            <div className="w-full flex-col justify-center items-start gap-8 flex">
              <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                ...
                <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                  ...
                  Voluptas ipsam voluptates consequatur quae doloremque
                  recusandae eius maxime et hic eos! Quis, minima, voluptate,
                  expedita dolor suscipit quod tempore tenetur ducimus magnam
                  ipsam consectetur facere debitis deserunt. Nesciunt amet nisi
                  in?
                </p>
              </div>
            ...
            <button className="sm:w-fit w-full px-3.5 py-2 bg-primary hover:bg-secondary transition-all duration-700 ease-in-out rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
