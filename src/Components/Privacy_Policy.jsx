...
const Privacy_Policy = () => {
  return (
    <div class="bg-gray-">
      <div class=" grid grid-cols-1 gap-4 mx-auto px-8 py-8 text-sm">
        <div className="">
          {/*  */}
        ...
        {/*  */}
        <div className="">
          <h2 class="text-xl font-bold mb-2">How We Use the Information</h2>
        ...
        <div className="">
          <h2 class="text-xl font-bold mb-2">Links to Other Websites</h2>
        ...
        <p class="mb-4 text-center md:text-md text-xs font-bold bg-gray-200 py-2 md:p-1 rounded-lg">
