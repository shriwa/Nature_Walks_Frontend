...
const Footer_2 = () => {
  ...
  return (
    <div className="bg-gray-50 text-primary">
      ...
      >
        <div className="flex md:flex-row flex-col md:items-center justify-center md:gap-20 md:mt-8">
          {/* Logo  */}
          ...
          {/* Menus & Services */}
          <div className="flex md:flex-row flex-col  md:items-start items-center justify-center gap-8 md:gap-20 md:mt-0 mt-8 md:mb-0 mb-8">
            {/* Services Links */}
            <div className="grid md:gap-4 gap-2 grid-cols-3 md:grid-cols-1 items-center justify-center md:mx-0 mx-4 md:mt-0">
              {services.map((slide) => (
                <a href={slide.link}>
                  <div
                    key={slide.id}
            ...
            {/* Menu Links */}
            <div className="md:mt-0 flex md:flex-col items-center justify-center">
              <ul className="grid md:grid-cols-1 grid-cols-3  justify-center items-center md:justify-start md:items-start gap-6 md:gap-6">
                {menus.map((menu, i) => (
                  <li key={i}>
                    <a
            ...
            {/* Social & Contact */}
            <div className=" flex md:flex-col flex-col items-center md:mt-0 mt-2 md:gap-12 gap-1">
              {/* <!-- Social media & Menus --> */}
              ...
              {/*  */}
              {/* Contact */}
              <div className="mb-4 mt-0 flex md:flex-col flex-col items-start md:gap-4 gap-2 text-sm list-none font-semibold text-gray-800">
